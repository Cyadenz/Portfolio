...
<div class="contenu">
	...
	<p class="description">
		...
		Il s'agit d'un projet où l'on devait réalisé un site Parking lié à une base de données. Ce site devait contenir une interface de connexion avec un partie réservée aux administrateurs.<br/>
